...
WebUI.setText(findTestObject('Login_register/Page_DEMOQA/input_UserName_userName'), GlobalVariable.username)

WebUI.setMaskedText(findTestObject('Login_register/Page_DEMOQA/input_Password_password'), GlobalVariable.password)
